        ...
        dragStop: function(e) {
            ...
            if (this.hasNewRoot) {
                if (this.options.fixed === true) {
                    ...
                    this.el.trigger('change'); //[OGF][21/10/2019][Permite controlar el evento change desde el JS de la Vista]
                }
                this.dragRootEl.trigger('gainedItem');
                this.dragRootEl.trigger('change'); //[OGF][21/10/2019][Permite controlar el evento change desde el JS de la Vista]
            }
            else {
